...
// auto typing heading
new (0, _typedJsDefault.default)(".auto--typed_word", {
    strings: [
        "Coding.",
        "You.",
        "Tech."
...
filterBtns.forEach((btn)=>{
    btn.addEventListener("click", function(curBtn) {
        ...
        if (curBtn.target.textContent === "All") allElements.forEach((el)=>el.style.display = "grid");
    });
});
...
sliderBtns.forEach((btn)=>{
    btn.addEventListener("click", function(e) {
        if (sliderIndex < indexLimit && e.target.classList.contains("control-btn_2")) {
            sliderIndex++;
            testimonialSlider.style.setProperty("--slider-index", sliderIndex);
            console.log(sliderIndex);
        } else if (sliderIndex <= indexLimit && sliderIndex != 0 && e.target.classList.contains("control-btn_1")) {
            sliderIndex--;
            console.log(sliderIndex);
            testimonialSlider.style.setProperty("--slider-index", sliderIndex);
        }
...
},{}]},["aleya","a2PJv"], "a2PJv", "parcelRequire3b74")
